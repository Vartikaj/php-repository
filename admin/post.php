      ...
      <div class="container">
          <div class="row">
              ...
              <?php
                ...
                $result = mysqli_query($con,$sql) or die('issue with select command');
              ...
              ?>
                  ...
                  <?php
                    ...
                    $query = mysqli_query($con,$sql1) or die('Query Failed');
                    if(mysqli_num_rows($query) > 0)
                    {
                        ...
                        if($total_page > $page)
                        {
                            echo '<li><a a href="post.php?page='.($page+1).'">Next</a></li>';
                        }
                        echo "</ul>";
                    }
                  ?>
